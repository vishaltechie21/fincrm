...
async function testConnection() {
  try {
    ...
    const alterColumnsSql = `
      ...
      IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'MASCOM' AND COLUMN_NAME = 'checklist_data')
        ALTER TABLE MASCOM ADD checklist_data NVARCHAR(MAX);
      IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'MASCOM' AND COLUMN_NAME = 'dashboard_data')
        ALTER TABLE MASCOM ADD dashboard_data NVARCHAR(MAX);
